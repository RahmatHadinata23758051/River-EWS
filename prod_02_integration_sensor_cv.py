...
class IntegratedEWS:
    ...
    def __init__(self):
        ...
        # Load sensor model
        sensor_model = Path("models/flood_dataset/rf_ews_model.pkl")
        le_status = Path("models/flood_dataset/le_status.pkl")
        le_weather = Path("models/flood_dataset/le_weather.pkl")
        ...
        # Load CV model
        cv_model = Path("checkpoints/best_model.pth")
        if cv_model.exists():
    ...
    def process_video(self):
        ...
        # Cari video file
        video_dirs = [Path("video"), Path("videos")]
        video_file = None
